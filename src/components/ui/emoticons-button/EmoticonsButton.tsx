...
import styles from "./emoticons-button.module.css";

interface EmoticonsButtonProps {
  onClick: () => void;
}

const EmoticonsButton: React.FC<EmoticonsButtonProps> = ({ onClick }) => {
  return (
    <svg
      fill="#000000"
      version="1.1"
    ...
    >
      <g>
        ...
        <path
          d="M242.5,355c-46.911,0-89.35-29.619-105.604-73.703l-28.148,10.378C129.329,347.496,183.08,385,242.5,385
...
export default EmoticonsButton;
